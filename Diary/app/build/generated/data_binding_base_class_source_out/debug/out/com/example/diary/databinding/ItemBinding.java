...
public final class ItemBinding implements ViewBinding {
  ...
  private ItemBinding(@NonNull LinearLayout rootView, @NonNull CardView cv, @NonNull TextView tvDay,
  ...
  public static ItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBinding((LinearLayout) rootView, cv, tvDay, tvMessage, tvTime);
    }
