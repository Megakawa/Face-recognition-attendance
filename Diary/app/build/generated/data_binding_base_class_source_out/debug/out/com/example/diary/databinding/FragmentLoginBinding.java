...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  private FragmentLoginBinding(@NonNull FrameLayout rootView, @NonNull Button btLogin,
      @NonNull EditText etPass, @NonNull EditText etUser, @NonNull TextView tvAddUser,
      @NonNull TextView tvForgot) {
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_addUser;
      TextView tvAddUser = ViewBindings.findChildViewById(rootView, id);
      if (tvAddUser == null) {
        break missingId;
      }
      ...
      return new FragmentLoginBinding((FrameLayout) rootView, btLogin, etPass, etUser, tvAddUser,
          tvForgot);
    }
